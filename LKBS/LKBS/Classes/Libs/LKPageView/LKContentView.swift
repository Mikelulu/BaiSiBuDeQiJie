...
extension LKContentView : UICollectionViewDelegate{
    ...
    func scrollViewDidScroll(_ scrollView: UIScrollView) {
        //MARK:- delegate 33
        //点击标题会调用在LKContentView.swift中的LKTitleViewDelegate实现的代理方法func titleView(_ titleView: LKTitleView, targetIndex: Int)，此时这个 func中的代码collectionView.scrollToItem又会调用scrollViewDidScroll
